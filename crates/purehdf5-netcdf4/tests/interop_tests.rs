//! NetCDF-4 interop tests: Python creates NetCDF-4 files, purehdf5-netcdf4 reads them.
//!
//! Tests are skipped if python3 or netCDF4/xarray Python packages are not available.

use std::process::Command;

use purehdf5_netcdf4::{AttrValue, NetCDF4File};
...
// ===========================================================================
// 1. Python netCDF4 creates file with dims, vars, CF attrs -> read with purehdf5
// ===========================================================================

#[test]
fn netcdf4_python_creates_cf_file_purehdf5_reads() {
    skip_if_no_netcdf4!();
...
// ===========================================================================
// 2. Python xarray creates file -> purehdf5 reads dimensions and variables
// ===========================================================================

#[test]
fn xarray_creates_file_purehdf5_reads() {
    skip_if_no_xarray!();
    let dir = tempfile::tempdir().unwrap();
...
// ===========================================================================
// 3. Python netCDF4 creates file with groups -> purehdf5 reads groups
// ===========================================================================

#[test]
fn netcdf4_python_creates_grouped_file_purehdf5_reads() {
    skip_if_no_netcdf4!();
    let dir = tempfile::tempdir().unwrap();
