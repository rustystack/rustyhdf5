...
/// which is not exposed by the high-level purehdf5 Dataset API.
fn check_unlimited(
    file: &purehdf5::File,
    group: &purehdf5::Group<'_>,
    ds_name: &str,
...
fn check_unlimited_low_level(
    ...
    // The purehdf5 Dataset stores the ObjectHeader but doesn't expose the address.
