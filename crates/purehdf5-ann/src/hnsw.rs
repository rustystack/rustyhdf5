...
use purehdf5_format::file_writer::{AttrValue, FileWriter as FmtWriter};
...
use purehdf5_format::data_read::{read_as_f32, read_as_i32, read_raw_data_full};
use purehdf5_format::filter_pipeline::FilterPipeline;
use purehdf5_format::attribute::extract_attributes_full;
use purehdf5_io::FileWriter as IoFileWriter;
use purehdf5_io::HDF5ReadWrite;
...
fn decode_simple_attr(attr: &purehdf5_format::attribute::AttributeMessage) -> Option<AttrValue> {
...
mod tests {
    ...
    fn save_to_file_writer() {
        ...
        let path = dir.join("purehdf5_ann_test_save.h5");
